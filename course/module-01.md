# Module 1 — What You're About to Build
...
1. **A computer.** Mac or Windows, doesn't matter. Even a basic laptop is fine.
2. **An internet connection.** For the setup and deploying your site. You can actually edit offline once everything's installed.
3. **About 2 hours.** Maybe less if you're quick. The first 30 minutes is setup, the rest is building.
4. **An Anthropic account.** For Claude Code. You'll set this up in the next module.
5. **A GitHub account.** Free. You'll set this up too.
