(function() {
  ...
  var isCustomer = GabUtils.getLS('gab_customer') === '1';
  var leadCaptured = GabUtils.getLS('gab_lead_captured') === '1';
  var popupDismissed = GabUtils.getLS('gab_lead_popup_dismissed') === '1';
  var exitDismissed = GabUtils.getLS('gab_exit_dismissed') === '1';
    ...
    form.addEventListener('submit', function(e) {
      ...
      .then(function(response) {
        if (response.ok) {
          ...
          // Track
          GabUtils.setLS('gab_lead_captured');
          leadCaptured = true;
  ...
  document.querySelectorAll('.modal-close').forEach(function(btn) {
    btn.addEventListener('click', function() {
      ...
      if (modal === leadModal) {
        GabUtils.setLS('gab_lead_popup_dismissed');
        popupDismissed = true;
      } else if (modal === exitModal) {
        GabUtils.setLS('gab_exit_dismissed');
        exitDismissed = true;
      }
    });
  });
