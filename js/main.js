(function() {
  ...
  var isCustomer = StorageUtils.get('gab_customer') === '1';
  var leadCaptured = StorageUtils.get('gab_lead_captured') === '1';
  var popupDismissed = StorageUtils.get('gab_lead_popup_dismissed') === '1';
  var exitDismissed = StorageUtils.get('gab_exit_dismissed') === '1';
    ...
    form.addEventListener('submit', function(e) {
      ...
      .then(function(response) {
        if (response.ok) {
          ...
          // Track
          StorageUtils.set('gab_lead_captured', '1');
          leadCaptured = true;
  ...
  document.querySelectorAll('.modal-close').forEach(function(btn) {
    btn.addEventListener('click', function() {
      ...
      if (modal === leadModal) {
        StorageUtils.set('gab_lead_popup_dismissed', '1');
        popupDismissed = true;
      } else if (modal === exitModal) {
        StorageUtils.set('gab_exit_dismissed', '1');
        exitDismissed = true;
      }
    });
  });
