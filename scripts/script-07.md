...
**Tone:** Steady, methodical, reassuring. "I know Git sounds scary but it's literally 6 commands."

---

## INTRO — GIT IS NOT SCARY

1. [SHOW: Terminal open, website project folder visible]
2. Okay. Real talk.
...
9. [SHOW: Text on screen — "6 commands. That's it."]
...
14. And by the end of this video, your code is gonna be safely stored in the cloud.
15. [BEAT]
...
17. [SHOW: Text on screen — "What is Git?"]
18. So. Git.
19. [BEAT]
...
22. [SHOW: Brief visual — Google Docs version history sidebar, or a simple illustration of it]
...
29. [SHOW: Simple visual — timeline with dots representing commits, arrow going back to an earlier one]
...
33. [SHOW: Text on screen — "What is GitHub?"]
34. Now. GitHub.
...
41. [SHOW: Visual — left side "Git = version history" right side "GitHub = Google Drive for code"]
...
63. `git init`
64. [HIT ENTER]
65. [SHOW: Terminal output — "Initialized empty Git repository in /Users/..."]
66. [BEAT]
...
72. [SHOW: Terminal, still in project folder]
...
86. [HIT ENTER]
87. [SHOW: Claude generating a .gitignore file with entries like .DS_Store, node_modules, .env, etc.]
88. [PAUSE — let it generate]
...
96. [SHOW: Terminal, project folder]
...
117. `git status`
118. [HIT ENTER]
119. [SHOW: Terminal output — list of files in green text]
120. [BEAT]
...
139. [HIT ENTER]
140. [SHOW: Terminal output — files committed, summary of changes]
141. [PAUSE — let the output show]
...
151. [SHOW: Browser opening, navigating to github.com]
...
156. [BEAT]
157. [SHOW: GitHub homepage, logged in]
158. Okay. See that little plus icon in the top right?
159. [SHOW: Mouse hovering over the "+" icon in the top-right corner of GitHub]
160. Click that. Then click "New repository."
161. [CLICK: + → New repository]
162. [SHOW: GitHub "Create a new repository" page]
163. [BEAT]
...
177. [SHOW: The initialization options — README, .gitignore, license checkboxes]
...
182. [BEAT]
183. [SHOW: Mouse clicking "Create repository"]
184. Click "Create repository."
185. [CLICK: Create repository]
186. [SHOW: The new empty repo page with setup instructions]
187. [PAUSE]
...
223. [HIT ENTER]
224. [SHOW: Terminal output — push progress, objects being uploaded, "Branch 'main' set up to track remote branch"]
225. [PAUSE — let it run]
226. [BEAT]
...
232. [SHOW: Browser, GitHub repo page]
...
238. [SHOW: GitHub repo with all files listed — index.html, styles.css, images folder, etc.]
239. [PAUSE — let it sink in]
...
246. [SHOW: The HTML code displayed on GitHub]
247. [BEAT]
...
251. [SHOW: Text on screen — "Common Errors (Don't Panic)"]
...
255. [BEAT]
256. [SHOW: Error text — "error: remote origin already exists"]
...
265. [BEAT]
266. [SHOW: Error text — "Authentication failed"]
...
277. [BEAT]
278. [SHOW: Error text — "failed to push some refs"]
...
308. [SHOW: Claude executing git add, git commit, git push automatically]
309. [PAUSE — let it run]
310. [BEAT]
...
321. [SHOW: Text on screen — "Recap: What We Did"]
322. Let's recap what just happened.
323. [BEAT]
324. [SHOW: Numbered list appearing one at a time]
