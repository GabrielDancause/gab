...
9. [SHOW: Mock business card with github.io URL on it]
10. They're gonna think you're a developer, not a bakery.
11. [BEAT]
12. [SHOW: Mock business card with goldencrust.com on it]
...
48. [BEAT]
49. [SHOW: Text on screen with a red X — "GoDaddy"]
...
67. [SHOW: Text on screen — "Step 2: Tell GitHub"]
68. Step two. We need to tell GitHub that your site has a custom domain.
69. [BEAT]
70. [SHOW: GitHub — navigate to your repository]
71. Go to your repository on GitHub.
72. [SHOW: Click Settings tab at the top of the repo]
73. Click Settings.
74. [SHOW: Scroll down in Settings, click "Pages" in the left sidebar]
75. In the left sidebar, click Pages.
76. [SHOW: GitHub Pages settings — the "Custom domain" field]
77. And right here — Custom domain. See that text field?
78. [BEAT]
79. [SHOW: Typing the domain name into the Custom domain field — e.g., goldencrust.com]
80. Type in your domain. No "www." No "https." Just the plain domain. Like goldencrust dot com.
81. [SHOW: Click Save button]
82. Hit Save.
83. [BEAT]
84. [SHOW: The repo now shows a CNAME file was created]
...
90. [SHOW: Text on screen — "Step 3: DNS Records"]
...
96. [BEAT]
97. [SHOW: Cloudflare DNS management page — or Namecheap, whichever is the example]
98. Go to your registrar's DNS settings. It might be called DNS Management, or DNS Records, or something like that.
99. [BEAT]
100. [SHOW: Existing DNS records — if any default records exist]
...
127. [SHOW: Text on screen — "Step 4: Wait for DNS"]
...
131. [BEAT]
132. [SHOW: Text on screen — "5 minutes to 24 hours"]
...
136. [SHOW: Browser — navigate to dnschecker.org]
137. You can check the progress at dnschecker dot org.
138. [SHOW: Typing the domain into dnschecker.org — results showing green checkmarks spreading across the map]
...
146. [SHOW: Text on screen — "Step 5: Enable HTTPS"]
147. Step five. HTTPS. The little padlock icon in the browser.
148. [BEAT]
149. [SHOW: Browser URL bar — highlight the padlock icon on any HTTPS site]
...
153. [BEAT]
154. [SHOW: GitHub — Settings → Pages]
155. Go back to GitHub. Settings. Pages.
156. [SHOW: The "Enforce HTTPS" checkbox on GitHub Pages settings]
157. See that checkbox that says "Enforce HTTPS"?
158. [BEAT]
159. Check it.
160. [SHOW: Checking the "Enforce HTTPS" box]
161. That's it. GitHub gives you a free SSL certificate. Free. Most hosts charge for this.
162. [BEAT]
163. [SHOW: Text on screen — "Greyed out? Wait a bit."]
...
165. [BEAT]
166. [SHOW: Browser — navigate to the custom domain with HTTPS — padlock shows]
...
170. [SHOW: Text on screen — "SEO Basics"]
...
176. [SHOW: Google search for the business name — no results]
...
178. [SHOW: Text on screen — "Meta Tags"]
179. First up. Meta tags. These are invisible bits of info in your code that tell search engines what your pages are about.
180. [BEAT]
181. [SHOW: Terminal — Claude Code open in the project folder]
182. Here's the prompt.
183. [SHOW: The prompt appearing on screen as Gab reads it]
...
185. [BEAT]
186. [SHOW: Claude Code updating the HTML files — adding meta tags to the head sections]
187. Look at Claude go. It's adding unique titles and descriptions to every page.
188. [BEAT]
189. [SHOW: Browser — view page source, highlight the meta tags in the head]
...
194. [SHOW: Text on screen — "robots.txt & sitemap.xml"]
195. Next. Two small files that make a big difference.
196. [BEAT]
197. [SHOW: Terminal — cursor ready]
...
199. [BEAT]
200. [SHOW: Claude Code creating both files]
...
202. [BEAT]
203. [SHOW: Browser — navigate to yourdomain.com/robots.txt, then /sitemap.xml]
...
207. [SHOW: Text on screen — "Structured Data (JSON-LD)"]
...
213. [SHOW: Terminal — cursor ready]
214. Here's the prompt.
215. [SHOW: The prompt appearing on screen]
...
217. [BEAT]
218. [SHOW: Claude Code adding the JSON-LD script tag to index.html]
219. Claude drops in a script tag with all your business info formatted exactly how Google wants it.
220. [BEAT]
221. [SHOW: Google Rich Results Test page — paste URL or code]
...
277. [BEAT]
278. [SHOW: Text on screen — "Next: Module 10 — Making Changes & Keeping It Updated"]
